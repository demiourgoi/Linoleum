...
public class MistralClient {
     ...
     * @throws MistralClientException If there is an error communicating with the API or the response is not successful
     */
    public MistralChatResponse sendCompletion(String messageContent) {
        try (CloseableHttpClient httpclient = HttpClients.createDefault()) {
            ...
            throw new MistralClientException("Failed to close HTTP client resources", e);
        }
    }
}